...
def format_tool_result(tool_name: str, tool_output: str) -> str:
    """
    ...
    return "\n".join([
        ...
        f'<div style="display: flex; align-items: center;"> 🔧 Tool: <code style="color: #ffaa00; background: none; border: none; margin-left: 5px;">{html.escape(tool_name)}</code></div>',
